...
N_CV_FOLDS        = 10
LAMBDA_GRID       = np.logspace(-4, 3, 15)    # comps: penalises deviation from basket prior
LAMBDA_GRID_RANKS = np.logspace(0, 5, 15)     # ranks: penalises non-smoothness across ranks
